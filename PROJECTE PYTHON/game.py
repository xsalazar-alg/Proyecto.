...
import random
import os
from functions import getOpt, borrarPantalla, ChooseYourDeck, maxRounds, crear_nombre, crear_dni, establecer_tipo, crear_jugador
...
# ESTO ES PARA PLAY GAME
"""
players = {"11115555A":{"name":"Mario", "human":True, "bank":False, "initialCard":"", "priority":0, "type":40, "bet":4, 
    ...
    while opc == 1:
        ...
        if opc1 == 3:
            ...
            item_str += "papa".rjust(4) + "            " + "papa".ljust(12) + "papa".rjust(10) + "||".rjust(16) + \
                        "papa".rjust(7) + "papa".rjust(16) + "papa".rjust(18)
